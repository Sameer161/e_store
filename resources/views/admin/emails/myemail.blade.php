    ...
    <div style="width: 800px;margin: 0px auto;">
        ...
        <div class="new">
            <section style="overflow: hidden;padding: 0px 14px;border-right: 4px solid black;border-left: 4px solid black;overflow: hidden;margin: 35px 0px;border-radius: 6px;">
                <div style="float: left;">
                    <p style="margin-bottom: 8px;margin-top: 0px;font-size: 16px;font-family: 'Google Sans';">{{ $details['body'][0]['orderdetail']['name']}}</p>
                    <p style="margin-bottom: 8px;margin-top: 0px;font-size: 16px;font-family: 'Google Sans';"><a href="" style="color: black!important;text-decoration: none !important">{{ $details['body'][0]['orderdetail']['email'] }}</a></p>
                    <p style="margin-bottom: 8px;margin-top: 0px;font-size: 16px;font-family: 'Google Sans';">{{ $details['body'][0]['orderdetail']['phone'] }}</p>
                </div>
                <div style="float: right;">
                    <p style="margin-bottom: 8px;margin-top: 0px;font-size: 16px;font-family: 'Google Sans';"><span><b>Invoice:</b></span> {{ $details['body'][0]['orderdetail']['invoice'] }}</p>
                </div>
            </section>
        </div>
        <table cellspacing="5px" cellpadding="6px" style="width: 100%;margin-bottom: 35px;">
            ...
            <tbody style="text-align: center;background: #eaeaea;">
                ...
                <tr>
                    <td style="font-family: 'Google Sans'; font-size: 15px;">{{ $new->prname }}</td>
                    <td style="font-family: 'Google Sans'; font-size: 15px;">{{ $new->quantity }}</td>
                    <td style="font-family: 'Google Sans'; font-size: 15px;">{{ $new->price }}</td>
                </tr>
                @endforeach()
            </tbody>
        </table>
        <div style="text-align:right;">
            <p style="font-family: 'Google Sans'; font-size: 15px;"><span><b>Subtotal Total: </b></span>{{ $details['body'][0]['orderdetail']['total'] }}</p>
            <p style="font-family: 'Google Sans'; font-size: 15px;"><span><b>Shippment Charges: </b></span>7</p>
            <p style="font-family: 'Google Sans'; font-size: 15px;"><span><b>Grand Total: </b></span>{{ $details['body'][0]['orderdetail']['total']+7}}</p>
        </div>
