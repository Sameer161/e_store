...
<ul class="menu-inner py-1">
  ...
  <!-- Layouts -->
  <li class="menu-item @if(url()->current()==url('/addcategories')||url()->current()==url('/showcategories')||url()->current()==url('/updatecategories')) active @endif">
...
<script src="{{asset('asset/js/perfect-scrollbar.js') }}"></script>
